"""Artifort (artifort.com) — dedicated collection-path scraper."""
...
discover_product_urls = collection_paths.discover_product_urls


def scrape_product_page(product_url: str, brand_name: str, timeout: float) -> ScrapedProduct:
    return collection_paths.scrape_product_page(product_url, brand_name, timeout)
