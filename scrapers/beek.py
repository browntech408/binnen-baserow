"""BEEK Collection (beekcollection.nl) — dedicated root-path scraper."""
from __future__ import annotations

import time

from product_schema import ScrapedProduct
from scrapers import root_paths

discover_product_urls = root_paths.discover_product_urls


def scrape_product_page(product_url: str, brand_name: str, timeout: float) -> ScrapedProduct:
    return root_paths.scrape_product_page(product_url, brand_name, timeout)
