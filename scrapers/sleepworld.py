"""Sleep World (sleepworldhelmond.nl) — dedicated WooCommerce scraper."""
from __future__ import annotations

import time

from product_schema import ScrapedProduct
from scrapers import woocommerce

discover_product_urls = woocommerce.discover_product_urls


def scrape_product_page(product_url: str, brand_name: str, timeout: float) -> ScrapedProduct:
    return woocommerce.scrape_product_page(product_url, brand_name, timeout)
